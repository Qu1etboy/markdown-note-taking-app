...
const Sidenav = () => {
  ...
  return (
    <div
      className="w-80 h-screen relative shadow-md border-r dark:border-neutral-700 hidden lg:block"
    ...
    >
        ...
        >
          <div className="flex items-center relative">
            ...
            {toggleDropDown && (
              <div
                id="dropdown"
                className="z-10 w-44 rounded top-10 divide-y divide-gray-300 dark:divide-gray-500 shadow bg-gray-200 dark:bg-gray-700 absolute mt-3"
              >
      ...
      <ul className="relative px-1">
        ...
        <li className="relative" id="sidenavSecEx2">
          <Link
            ...
            to="/todos"
          >
            <FaClipboardList className="w-3 h-3 mr-3" />
            <span>Todos</span>
            <svg
              aria-hidden="true"
              focusable="false"
          ...
          >
            <li className="relative">
              <a
                href="#!"
                className="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-gray-700 dark:text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out"
        ...
        <li className="relative" id="sidenavXxEx3">
          ...
          >
            <li className="relative">
              <a
                href="#!"
                className="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden dark:text-white text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out"
                data-mdb-ripple="true"
                data-mdb-ripple-color="primary"
              >
                Link 7
      ...
      <div className="text-center bottom-0 absolute w-full">
        <hr className="m-0 dark:border-neutral-700" />
        <p className="py-2 text-sm text-gray-700 dark:text-white">
